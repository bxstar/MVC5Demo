...
// 
namespace iclickpro.BusinessLayer.WService.FindWord
{
    using System;
    ...
    public partial class WebServiceForKeywordForecast : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        private System.Threading.SendOrPostCallback KeywordBaseCacheOldOperationCompleted;
        ...
        {
            this.Url = "http://121.196.129.114:30002/WebServiceForKeywordForecast.asmx";
        }
        ...
        /// <remarks/>
        public event KeywordBaseCacheOldCompletedEventHandler KeywordBaseCacheOldCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/KeywordBaseCacheOld", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public EntityWordBase[] KeywordBaseCacheOld(string strKeywords)
        {
            object[] results = this.Invoke("KeywordBaseCacheOld", new object[] {
                        strKeywords});
            return ((EntityWordBase[])(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginKeywordBaseCacheOld(string strKeywords, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("KeywordBaseCacheOld", new object[] {
                        strKeywords}, callback, asyncState);
        }

        /// <remarks/>
        public EntityWordBase[] EndKeywordBaseCacheOld(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((EntityWordBase[])(results[0]));
        }
        ...
        /// <remarks/>
        public void KeywordBaseCacheOldAsync(string strKeywords)
        {
            this.KeywordBaseCacheOldAsync(strKeywords, null);
        }

        /// <remarks/>
        public void KeywordBaseCacheOldAsync(string strKeywords, object userState)
        {
            if ((this.KeywordBaseCacheOldOperationCompleted == null))
            {
                this.KeywordBaseCacheOldOperationCompleted = new System.Threading.SendOrPostCallback(this.OnKeywordBaseCacheOldOperationCompleted);
            }
            this.InvokeAsync("KeywordBaseCacheOld", new object[] {
                        strKeywords}, this.KeywordBaseCacheOldOperationCompleted, userState);
        }

        private void OnKeywordBaseCacheOldOperationCompleted(object arg)
        {
            if ((this.KeywordBaseCacheOldCompleted != null))
            {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.KeywordBaseCacheOldCompleted(this, new KeywordBaseCacheOldCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.1")]
    public delegate void KeywordBaseCacheOldCompletedEventHandler(object sender, KeywordBaseCacheOldCompletedEventArgs e);

    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.0.30319.1")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class KeywordBaseCacheOldCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {

        private object[] results;

        internal KeywordBaseCacheOldCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) :
            base(exception, cancelled, userState)
        {
            this.results = results;
        }
